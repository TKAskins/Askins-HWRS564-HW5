    ...
    cdef int init(
        ...
        for p in range(start, end):
            ...
            for k in range(self.n_outputs):
                ...
                # self.sq_sum += y_ik * y_ik

                self.sq_sum += self.sum_total[k] * self.sum_total[k]
...
cdef class MSE(RegressionCriterion):
    ...
    # cdef float64_t sq_sum_total(self) noexcept nogil:
    #     return self.sq_sum_total

    # cdef float64_t sum_total_sum(self) noexcept nogil:
    #     cdef float64_t sum_total_sum
    #     cdef intp_t k

    #     for k in range(self.n_outputs):
    #         sum_total_sum += self.sum_total[k]

    #     return sum_total_sum
