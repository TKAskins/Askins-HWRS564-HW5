...
cdef inline int node_split_best(
    ...
    if tree_efficient_cost_flag and (node_count > 0):
        ...
        if num_nodes_valid > 0:
            ...
            # impurity = obj_arr[max_ind,0]

            # impurity = criterion.sq_sum_total / criterion.weighted_n_node_samples
            impurity = criterion.sq_sum / criterion.weighted_n_node_samples
            ...
            for node_id in range(num_nodes_valid):
                ...
                # diff = node_improvement / impurity
    ...
    if not best_cost_flag:
        # if (node_count == 0):
        #     best_cost_flag = True
        if (best_split.improvement / impurity) < imp_threshold:
            best_cost_flag = True
