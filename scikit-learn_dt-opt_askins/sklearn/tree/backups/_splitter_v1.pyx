...
# from libc.math cimport fabs # bad import??
...
# cdef float64_t abs_float(float64_t x) noexcept nogil:
#     if x < 0:
#         return -x
#     else:
#         return x
...
cdef inline int node_split_best(
    ...
    #     diff = abs_float(obj_arr[max_ind][0] - obj_arr[n_ind][0]) / obj_arr[max_ind][0]
