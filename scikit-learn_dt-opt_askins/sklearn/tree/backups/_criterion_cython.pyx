...
cdef cnp.float64_t EPSILON = 10 * np.finfo('double').eps
...
cdef class Criterion:
    ...
    cdef int init(
        ...
        weighted_n_samples : cnp.float64_t
            The total weight of the samples being considered
        sample_indices : ndarray, dtype=cnp.intp_t
    ...
    cdef void children_impurity(self, cnp.float64_t* impurity_left,
                                cnp.float64_t* impurity_right) noexcept nogil:
        ...
        Parameters
        ----------
        impurity_left : cnp.float64_t pointer
            The memory address where the impurity of the left child should be
            stored.
        impurity_right : cnp.float64_t pointer
    ...
    cdef cnp.float64_t proxy_impurity_improvement(self) noexcept nogil:
        ...
        """
        cdef cnp.float64_t impurity_left
        cdef cnp.float64_t impurity_right
        self.children_impurity(&impurity_left, &impurity_right)

        return (- self.weighted_n_right * impurity_right
                - self.weighted_n_left * impurity_left)

    cdef cnp.float64_t impurity_improvement(self, cnp.float64_t impurity_parent,
        ...
        Parameters
        ----------
        impurity_parent : cnp.float64_t
            The initial impurity of the parent node before the split

        impurity_left : cnp.float64_t
            The impurity of the left child

        impurity_right : cnp.float64_t
            The impurity of the right child

        Return
        ------
        cnp.float64_t : improvement in impurity after the split occurs
        """
    ...
    cdef inline bint _check_monotonicity(
        ...
        cnp.float64_t lower_bound,
        cnp.float64_t upper_bound,
        cnp.float64_t value_left,
        cnp.float64_t value_right,
    ) noexcept nogil:
        cdef:
...
cdef inline void _move_sums_classification(
    ...
    cnp.float64_t[:, ::1] sum_1,
    cnp.float64_t[:, ::1] sum_2,
    cnp.float64_t* weighted_n_1,
    cnp.float64_t* weighted_n_2,
...
cdef class ClassificationCriterion(Criterion):
    ...
    def __cinit__(self, cnp.intp_t n_outputs,
                  cnp.ndarray[cnp.intp_t, ndim=1] n_classes):
        """Initialize attributes for this criterion.

        Parameters
        ----------
        n_outputs : cnp.intp_t
            The number of targets, the dimensionality of the prediction
        n_classes : numpy.ndarray, dtype=cnp.intp_t
        ...
        cdef cnp.intp_t k = 0
        cdef cnp.intp_t max_n_classes = 0
    ...
    cdef int init(
        ...
        cdef cnp.intp_t k
        cdef cnp.intp_t c
        cdef cnp.float64_t w = 1.0

        for k in range(self.n_outputs):
            memset(&self.sum_total[k, 0], 0, self.n_classes[k] * sizeof(cnp.float64_t))
    ...
    cdef void init_missing(self, cnp.intp_t n_missing) noexcept nogil:
        ...
        memset(&self.sum_missing[0, 0], 0, self.max_n_classes * self.n_outputs * sizeof(cnp.float64_t))
    ...
    cdef int update(self, cnp.intp_t new_pos) except -1 nogil:
        ...
        cdef cnp.intp_t end_non_missing = self.end - self.n_missing

        cdef cnp.intp_t[:] sample_indices = self.sample_indices
        cdef const cnp.float64_t[:] sample_weight = self.sample_weight
        ...
        if (new_pos - pos) <= (end_non_missing - new_pos):
            for p in range(pos, new_pos):
                ...
                for k in range(self.n_outputs):
                    self.sum_left[k, <cnp.intp_t> self.y[i, k]] += w
    ...
    cdef inline void clip_node_value(
        self, cnp.float64_t * dest, cnp.float64_t lower_bound, cnp.float64_t upper_bound
    ) noexcept nogil:
    ...
    cdef inline cnp.float64_t middle_value(self) noexcept nogil:
    ...
    cdef inline bint check_monotonicity(
        ...
        cdef:
            cnp.float64_t value_left = self.sum_left[0][0] / self.weighted_n_left
            cnp.float64_t value_right = self.sum_right[0][0] / self.weighted_n_right
...
cdef class Entropy(ClassificationCriterion):
    ...
    cdef cnp.float64_t node_impurity(self) noexcept nogil:
        ...
        better.
        """
        cdef cnp.float64_t entropy = 0.0
        cdef cnp.float64_t count_k
        cdef cnp.intp_t k
        cdef cnp.intp_t c
    ...
    cdef void children_impurity(self, cnp.float64_t* impurity_left,
        ...
        """
        cdef cnp.float64_t entropy_left = 0.0
        cdef cnp.float64_t entropy_right = 0.0
        cdef cnp.float64_t count_k
        cdef cnp.intp_t k
        cdef cnp.intp_t c
...
cdef class Gini(ClassificationCriterion):
    ...
    cdef cnp.float64_t node_impurity(self) noexcept nogil:
        ...
        better.
        """
        cdef cnp.float64_t gini = 0.0
        cdef cnp.float64_t sq_count
        cdef cnp.float64_t count_k
        cdef cnp.intp_t k
        cdef cnp.intp_t c
    ...
    cdef void children_impurity(self, cnp.float64_t* impurity_left,
        ...
        """
        cdef cnp.float64_t gini_left = 0.0
        cdef cnp.float64_t gini_right = 0.0
        cdef cnp.float64_t sq_count_left
        cdef cnp.float64_t sq_count_right
        cdef cnp.float64_t count_k
        cdef cnp.intp_t k
        cdef cnp.intp_t c
...
cdef inline void _move_sums_regression(
    ...
    cdef:
        cnp.intp_t i
        cnp.intp_t n_bytes = criterion.n_outputs * sizeof(cnp.float64_t)
...
cdef class RegressionCriterion(Criterion):
    ...
    def __cinit__(self, cnp.intp_t n_outputs, cnp.intp_t n_samples):
    ...
    cdef int init(
        ...
        cdef cnp.intp_t p
        cdef cnp.intp_t k
        cdef cnp.float64_t y_ik
        cdef cnp.float64_t w_y_ik
        cdef cnp.float64_t w = 1.0
        self.sq_sum_total = 0.0
        memset(&self.sum_total[0], 0, self.n_outputs * sizeof(cnp.float64_t))
    ...
    cdef void init_missing(self, cnp.intp_t n_missing) noexcept nogil:
        ...
        memset(&self.sum_missing[0], 0, self.n_outputs * sizeof(cnp.float64_t))
    ...
    cdef bint check_monotonicity(
        ...
        cdef:
            cnp.float64_t value_left = self.sum_left[0] / self.weighted_n_left
            cnp.float64_t value_right = self.sum_right[0] / self.weighted_n_right
...
cdef class MSE(RegressionCriterion):
    ...
    cdef cnp.float64_t proxy_impurity_improvement(self) noexcept nogil:
        ...
        """
        cdef cnp.intp_t k
        cdef cnp.float64_t proxy_impurity_left = 0.0
        cdef cnp.float64_t proxy_impurity_right = 0.0
    ...
    cdef void children_impurity(self, cnp.float64_t* impurity_left,
        ...
        cdef cnp.intp_t[:] sample_indices = self.sample_indices
        cdef cnp.intp_t pos = self.pos
        cdef cnp.intp_t start = self.start

        cdef cnp.float64_t y_ik

        cdef cnp.float64_t sq_sum_left = 0.0
        cdef cnp.float64_t sq_sum_right
...
#     cdef cnp.float64_t[::1] node_medians
...
#         cdef cnp.intp_t k
#         for k in range(self.n_outputs):
#             dest[k] = <cnp.float64_t> self.node_medians[k]
...
#         """Check monotonicity constraint is satisfied at the current regression split"""
#         cdef:
#             cnp.float64_t value_left = (<WeightedMedianCalculator> self.left_child_ptr[0]).get_median()
#             cnp.float64_t value_right = (<WeightedMedianCalculator> self.right_child_ptr[0]).get_median()
...
#         cdef cnp.intp_t i, p, k
#         cdef cnp.float64_t w = 1.0
#         cdef cnp.float64_t impurity = 0.0
...
#     cdef void children_impurity(self, cnp.float64_t* p_impurity_left,
#                                 cnp.float64_t* p_impurity_right) noexcept nogil:
#         """Evaluate the impurity in children nodes.
...
#         cdef cnp.intp_t i, p, k
#         cdef cnp.float64_t median
#         cdef cnp.float64_t w = 1.0
#         cdef cnp.float64_t impurity_left = 0.0
#         cdef cnp.float64_t impurity_right = 0.0
...
cdef class FriedmanMSE(MSE):
    ...
    cdef cnp.float64_t proxy_impurity_improvement(self) noexcept nogil:
        ...
        impurity_improvement method once the best split has been found.
        """
        cdef cnp.float64_t total_sum_left = 0.0
        cdef cnp.float64_t total_sum_right = 0.0

        cdef cnp.intp_t k
        cdef cnp.float64_t diff = 0.0
    ...
    cdef cnp.float64_t impurity_improvement(self, cnp.float64_t impurity_parent, cnp.float64_t
                                        impurity_left, cnp.float64_t impurity_right) noexcept nogil:
...
cdef class Poisson(RegressionCriterion):
    ...
    cdef cnp.float64_t proxy_impurity_improvement(self) noexcept nogil:
        ...
        cdef cnp.float64_t proxy_impurity_left = 0.0
        cdef cnp.float64_t proxy_impurity_right = 0.0
        cdef cnp.float64_t y_mean_left = 0.
        cdef cnp.float64_t y_mean_right = 0.
    ...
    cdef inline cnp.float64_t poisson_loss(
        self,
        cnp.intp_t start,
        cnp.intp_t end,
        const cnp.float64_t[::1] y_sum,
        cnp.float64_t weight_sum
    ) noexcept nogil:
        """Helper function to compute Poisson loss (~deviance) of a given node.
        """
        cdef const cnp.float64_t[:, ::1] y = self.y
        cdef const cnp.float64_t[:] sample_weight = self.sample_weight
        cdef cnp.intp_t[:] sample_indices = self.sample_indices

        cdef cnp.float64_t y_mean = 0.
        cdef cnp.float64_t poisson_loss = 0.
        cdef cnp.float64_t w = 1.0
        cdef cnp.intp_t i, k, p
        cdef cnp.intp_t n_outputs = self.n_outputs
